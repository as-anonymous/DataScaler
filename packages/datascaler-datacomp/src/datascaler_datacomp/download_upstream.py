...
from datascaler_datacomp.scale import available_scales
...
if __name__ == "__main__":
    ...
    if args.overwrite_metadata or not metadata_dir.exists():
        ...
        snapshot_download(**hf_snapshot_args)  # type: ignore
        if args.download_npz:
            hf_snapshot_args["allow_patterns"] = hf_snapshot_args["allow_patterns"].replace(  # type: ignore
                ".parquet", ".npz"
            )
