...
from datascaler_open_clip.filter_utils.easyocr.DBNet.DBNet import DBNet
...
def get_detector(
    trained_model, backbone="resnet18", device="cpu", quantize=True, cudnn_benchmark=False
):
    """
