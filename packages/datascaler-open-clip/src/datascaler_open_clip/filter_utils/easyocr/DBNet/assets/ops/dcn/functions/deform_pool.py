...
try:
    ...
    try:
        ...
        deform_pool_cpu = cpp_extension.load(
            ...
            sources=[
                os.path.join(dcn_dir, "src", "deform_pool_cpu.cpp"),
...
if torch.cuda.is_available():
    try:
        ...
        warnings.warn(
            "Using precompiled deform_pool_cuda from {}".format(deform_pool_cuda.__file__)
        )
        dcn_cuda_ready = True
    except:
        try:
            ...
            deform_pool_cuda = cpp_extension.load(
                ...
                sources=[
                    os.path.join(dcn_dir, "src", "deform_pool_cuda.cpp"),
